...
<head>
    ...
    <title>Contact Acromedical</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="top_menu row m0">
            <div class="container">
                <div class="float-left">
                    <a class="dn_btn" href="mailto:info@erobyt.com"><i class="ti-email"></i>info@erobyt.com</a>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://erobyt.com" target="_blank">Erobyt</a>
<!-- Link back to Erobyt can't be removed. -->
                </p>
